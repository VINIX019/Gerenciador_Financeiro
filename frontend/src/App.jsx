...
function App() {
  ...
  const buscarSaldo = async (userId) => {
    ...
    try {
      const response = await axios.get(`https://gerenciador-financeiro-1-6cpc.onrender.com/usuarios/${userId}/saldo`, {
  ...
  const handleLogin = async (email, senha) => {
    try {
      const response = await axios.post('https://gerenciador-financeiro-1-6cpc.onrender.com/login', { email, senha });
  ...
  const handleRegister = async (nome, email, senha) => {
    try {
      await axios.post('https://gerenciador-financeiro-1-6cpc.onrender.com/usuarios', { nome, email, senha });
